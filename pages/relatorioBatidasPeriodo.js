...
const injectIt = (value) => {
    ...
    if (value == true) {
        ...
        <tbody>
            <tr>
            <th><a href="https://seusucesso.ahgora.com.br/kb/article/49145/pontoweb-como-gerar-relatorio-de-batidas-por-periodo?ticketId=&q=" target="_blank">Como gerar relatório de batidas por período</a></th>
            </tr>
        </tbody>
        </table>
        </div>`
