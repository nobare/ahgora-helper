...
const injectIt = (value) => {
    ...
    if (value == true) {
        ...
        <tbody>
            <tr>
            <th><a href="https://seusucesso.ahgora.com.br/kb/article/49146/pontoweb-como-gerar-relatorio-batidas-impares?ticketId=&q=" target="_blank">Como gerar relatório de batidas ímpares</a></th>
            </tr>
        </tbody>
        </table>
        </div>`
