...
const injectIt = (value) => {
    ...
    if (value == true) {
        ...
        <tbody>
            <tr>
            <th><a href="https://seusucesso.ahgora.com.br/kb/article/138465/pontoweb-como-usar-o-gerador-de-espelhos?ticketId=&q=" 
            target="_blank">Como usar o gerador de espelhos</a></th>
            </tr>
        </tbody>
        </table>
        </div>`
